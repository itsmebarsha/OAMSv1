...
// pages/index.js
import Addassignment from "@/components/assignmentAdmin/Addassignment";
import ViewAssignmentList from "@/components/assignmentAdmin/ViewAssignmentList";
import ViewSubmissionList from "@/components/assignmentAdmin/ViewSubmissionList";
import CredentialList from "@/components/loginCredential/CredentialList";
import AddStudent from "@/components/manageuser/AddStudent";
import Addcourse from "@/components/manageuser/Addcourse";
import Addsubject from "@/components/manageuser/Addsubject";
import Addteacher from "@/components/manageuser/Addteacher";
            ...
            <div>
              <div className=" border p-4 rounded">
                <h1 className="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">
                  Welcome to Online Assignment Management System
                </h1>
...
function DashboardAnalytics() {
    ...
    async function fetchStats() {
      try {
        const response = await axios.get(
          `/api/admin/analytics/getStats?schoolCode=${schoolCode}`
        );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `/api/admin/analytics/getTeacher?schoolCode=${schoolCode}`
        );
