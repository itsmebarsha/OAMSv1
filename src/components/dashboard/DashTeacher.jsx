...
// pages/index.js
import Addassignment from "@/components/assignmentTeacher/Addassignment";
import ViewAssignmentList from "@/components/assignmentTeacher/ViewAssignmentList";
import ViewSubmissionList from "@/components/assignmentTeacher/ViewSubmissionList";
...
function DashboardAnalytics() {
    ...
    async function fetchStats() {
      try {
        const response = await axios.get(
          `/api/teacher/analytics/getStats?schoolCode=${schoolCode}&teacherEmail=${schoolStore.userData.userEmail}`
        );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `/api/teacher/analytics/getTeacher?schoolCode=${schoolCode}&teacherEmail=${schoolStore.userData.userEmail}`
        );
