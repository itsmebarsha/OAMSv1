...
const TeacherCred = ({ isModalOpen, closeModal, user, onSaveSuccess }) => {
  ...
  const [password, setPassword] = useState(user.teacherPassword || "");
        ...
        <div className="bg-white rounded-lg flex flex-col">
          ...
          <div className="bg-gray-200 px-4 py-2 grid grid-cols-1 md:grid-cols-1 rounded-t-lg">
            <div className="flex items-center space-x-4">
              <h3 className="truncate font-semibold"> Teacher login details</h3>
            </div>
